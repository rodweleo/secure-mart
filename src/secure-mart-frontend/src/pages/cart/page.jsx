...
export default function CartPage() {
    ...
    return (
        <main className="flex h-full">
            <section className="w-full p-5 space-y-5 justify-between flex flex-col">
                <header className="flex justify-between font-bold sm:text-2xl">
                    <h1>Shopping Cart</h1>
            ...
            <section className="bg-gray-300/50 w-1/3 p-5 flex flex-col justify-between h-fit space-y-5">
                <header className="space-y-2.5">
                    <h1 className="flex justify-between font-bold sm:text-2xl">Order Summary</h1>
                ...
                <div className="w-full space-y-5">
                    ...
                    <button onClick={() => setOpen(true)} className="w-full bg-yellow-500 py-2 rounded-lg text-white font-semibold active:scale-95">CHECKOUT</button>
                </div>
            </section>

            {
                isOpen ? <section className="fixed inset-0 z-50 bg-black w-full h-full bg-opacity-70 grid place-items-center">
                            ...
                            <table className="w-full text-xl font-bold">
                                <tbody>
                                    ...
                                    <tr className="flex justify-between bg-slate-100">
                                        ...
                                        <td className="p-5">${amount ? amount : 0}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <footer className="p-5">
                            <button onClick={() => completeOrder()} disabled={isOrdering} className="disabled:bg-slate-200 disabled:cursor-not-allowed w-full bg-yellow-500 py-4 rounded-lg text-white font-semibold active:scale-[0.99] transition-all duration-200 ease-in-out text-xl">Complete Order</button>
                        </footer>
                    </div>
                </section> : null
            }
