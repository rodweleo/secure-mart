...
export default function MainHeader() {
    ...
    return (
        <header className='h-auto py-5 gap-5 bg-white flex flex-col items-center shadow-md shadow-slate-200 sticky top-0 z-50'>
                ...
                <div className="flex items-center gap-5">
                    ...
                    <ul className="flex gap-5">
                        ...
                        <div className="relative">
                            ...
                            {isOpen ? <ul className="text-left border space-y-3 w-[150px] absolute bg-white rounded-md p-2.5 right-0 mt-5 z-50">
            ...
            <div className="hidden max-md:block p-2.5">
                <SearchBox />
            </div>
        </header>
    )
